...
export const PROFILE_COMMENT_MIN_ACCOUNT_AGE_MS = 15 * 60 * 1000; // 15 minutes
export const PROFILE_COMMENT_COOLDOWN_MS = 60 * 1000; // 1 minute
export const PROFILE_COMMENT_DUPLICATE_WINDOW_MS = 5 * 60 * 1000; // 5 minutes
