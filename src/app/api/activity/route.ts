	...
	try {
		...
		const rows = await db
			.select({
				...
				actorSteamAvatarUrl: users.steamAvatarUrl,
				actorUseSteamAvatar: users.useSteamAvatar,
				actorDiscordAvatarUrl: users.discordAvatarUrl,
				actorUseDiscordAvatar: users.useDiscordAvatar,
		...
		return NextResponse.json(
			{
				data: rows.map((row) => ({
					...
					actor: {
						...
						steamAvatarUrl: row.actorSteamAvatarUrl,
						useSteamAvatar: row.actorUseSteamAvatar,
						discordAvatarUrl: row.actorDiscordAvatarUrl,
						useDiscordAvatar: row.actorUseDiscordAvatar,
					},
